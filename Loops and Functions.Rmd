...
Caution... this is challenging. If you find yourself wanting more of a challenge, do this. 
...
```{r}
# read in the data
EC50.data <- read.csv(file.choose())
...
To do this we use a non-linear regression of the radial growth of a fungus against the log concentration of a fungicide, and find the half-maximal response.
...
#The loop and saving each iterations output
